...
<p align="center">
  ...
  <a href="https://github.com/qinyin233/rupora/releases"><img src="https://img.shields.io/badge/version-2.0.0--alpha.3-f59e0b" alt="Version 2.0.0-alpha.3"></a>
...
> [!IMPORTANT]
> RUPORA 2 当前处于 `2.0.0-alpha.3` 阶段。可从 [Releases](https://github.com/qinyin233/rupora/releases)
...
- 原编码无法表示新增字符时，可在更多菜单或命令面板中选择“另存为 UTF-8…”；转换保留原换行风格
